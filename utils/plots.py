...
def plot_images(images, targets, paths=None, fname='images.jpg', names=None, max_size=640, max_subplots=16, box_color=None):
    ...
    for i, img in enumerate(images):
        ...
        if len(targets) > 0:
            ...
            correct = None if image_targets.shape[1] <= 7 else image_targets[:, 7].astype(bool)
            ...
            for j, box in enumerate(boxes.T):
                ...
                if box_color is not None:
                    ...
                    color = (0, 180, 0) if correct[j] else (255, 0, 0)
                else:
...
def plot_evolution(yaml_file='data/hyperparameters/hyp.finetune.yaml'):  # from utils.plots import *; plot_evolution()
